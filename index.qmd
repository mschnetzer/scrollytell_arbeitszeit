...
::: {.column-screen style="background-image:url(https://upload.wikimedia.org/wikipedia/commons/7/79/Eight_hour_campaign_in_Denmark_1912.jpg); background-size: cover; height: 70vh; clip-path: inset(70px 0px 0px 0px);"}
:::
<figcaption>Demonstration für den Achtstundentag in Dänemark, 1912.<br>(Quelle: [Wikipedia](https://en.wikipedia.org/wiki/Eight-hour_day_movement#/media/File:Eight_hour_campaign_in_Denmark_1912.jpg))</figcaption>
...
Bis Ende des 19. Jahrhundert war die Arbeitszeit nicht gesetzlich geregelt. Laut Gewerbeordnung galt ab 1885 in Fabriken eine Arbeitszeit von 11 Stunden pro Tag und 66 Stunden pro Woche.
@cr-gesetz
...
Vollzeitbeschäftigte in Österreich arbeiten immer noch deutlich länger als im [EU-Schnitt](https://doi.org/10.2908/LFSA_EWHUIS). In Österreich waren es im Jahr `{r} latest_year` etwa `{r} latest_at` Stunden pro Woche während der Durchschnitt über alle 27 EU-Staaten bei `{r} latest_eu` Stunden lag. @cr-vollzeit

Seit 2005 sinkt allerdings die durchschnittliche Normalarbeitszeit von Vollzeitbeschäftigten in Österreich deutlich. Von 2005 bis `{r} latest_year` immerhin um `{r} latest_diff` Stunden pro Woche. @cr-vollzeit
...
ggplot(over, aes(fill = typ, values = stunden)) +
  ...
  annotate("tile", x=1, y=1, color = "black", linewidth =.25, fill = "transparent") +
